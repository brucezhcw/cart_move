...
void Motor::Move_J(int arm, double pos[])
{
	ESOpen(2, IPAddress, &handle);
	ESSetTimeOut(handle, TIMEOUT, RETRY);

	ESCartMoveData DmoveData;
	...
	DmoveData.robotPos.dataType = 17;
	//DmoveData.robotPos.fig = 1;
	//DmoveData.robotPos.exFig = 0;
	DmoveData.robotPos.toolNo = 0;
	DmoveData.robotPos.userFrameNo = 1;
	DmoveData.robotPos.axesData.axis[0] = pos[0];
	DmoveData.robotPos.axesData.axis[1] = pos[1];
	DmoveData.robotPos.axesData.axis[2] = pos[2];
	DmoveData.robotPos.axesData.axis[3] = pos[3];
	DmoveData.robotPos.axesData.axis[4] = pos[4];
	DmoveData.robotPos.axesData.axis[5] = pos[5];
	DmoveData.robotPos.axesData.axis[6] = 0;
	DmoveData.robotPos.axesData.axis[7] = 0;
	...
	ESCartMove(handle, 1, DmoveData); //运动
	ESClose(handle);
}
